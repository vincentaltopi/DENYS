...
export default async function ProjectResultsPage({ params }: PageProps) {
  // Robust (au cas où l'env te “wrap” params)
        ...
        <div className="w-full">
          ...
          <div className="mb-6">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <DownloadMenu projectId={id} />

            </div>
          </div>

          {/* Main card */}
          <div className="rounded-2xl border border-emerald-950/10 bg-white p-5 shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
            <ResultsPanel projectId={id} />
          </div>
